...
import { PropertyStatus, PropertyType } from "./entities/property";
...
export async function seed(): Promise<void> {
	...
	// customers
	const customers = [
		{ email: "JohnDoe@email.com", phoneNumber: "0894791234", firstName: "John", lastName: "Doe" },
		{ email: "JoshBigWilly@email.com", phoneNumber: "0877778990", firstName: "Josh", lastName: "Wilis" },
		{ email: "Charlton.United@email.com", phoneNumber: "0871234567", firstName: "Booby", lastName: "Charlton" },
		{ email: "Sam_S2005@email.com", phoneNumber: "0870976543", firstName: "Sam", lastName: "Smith" },
		{ email: "MarkoPolo@email.com", phoneNumber: "0870998754", firstName: "Marko", lastName: "Butler" },
		{ email: "Bobby_D@email.com", phoneNumber: "0898008420", firstName: "Bob", lastName: "Dillion" },
	];
...
async function ensureUser(userRepo: ReturnType<typeof dataSource.getRepository<User>>, input: UserInput) {
...
async function ensureAdmin(adminRepo: ReturnType<typeof dataSource.getRepository<Admin>>, userId: string) {
...
async function ensureCustomer(customerRepo: ReturnType<typeof dataSource.getRepository<Customer>>, userId: string) {
...
async function ensureLandlord(landlordRepo: ReturnType<typeof dataSource.getRepository<Landlord>>, userId: string) {
