<script lang="ts">
  ...
  import { BookOpenCheck, CircleQuestionMark, CircleUser, House, LogIn, LogOut, Menu, UserPlus } from "lucide-svelte";
...
<div class="justify-self-end">
  ...
  <details class="dropdown dropdown-end relative">
      <summary class="btn btn-ghost btn-circle">
        ...
        <div class="menu dropdown-content z-1 mt-2 w-48 rounded-box border border-base-300 bg-base-100 p-2 shadow-lg">
          
          <a href={resolve("/auth/login")} class="btn btn-ghost"> Login <LogIn /></a>
          

          <a href={resolve("/auth/register")} class="btn btn-ghost"> Register <UserPlus /></a>
